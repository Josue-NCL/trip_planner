drop policy if exists trip_travelers_delete_editor on public.trip_travelers;
drop policy if exists trip_days_delete_editor on public.trip_days;
drop policy if exists schedule_items_delete_editor on public.schedule_items;
drop policy if exists ideas_delete_editor on public.ideas;
drop policy if exists idea_votes_delete_editor on public.idea_votes;
