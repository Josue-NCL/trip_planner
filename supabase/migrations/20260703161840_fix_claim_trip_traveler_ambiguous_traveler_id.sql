...
begin
  ...
  update public.trip_travelers as tt
  set profile_id = current_profile_id
  where tt.id = target_traveler_id;

  update public.idea_votes as iv
  set profile_id = current_profile_id
  where iv.traveler_id = target_traveler_id
    and iv.profile_id is null;

  return query select target_traveler_id as traveler_id;
end;
$$;
